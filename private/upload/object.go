...
func (o *ObjectMeta) EncryptedLastWrite(ctx context.Context, i int, bytes []byte) error {
	return o.Output.EncryptedLastWrite(ctx, i, bytes)
}
...
func (o *ObjectMeta) StartSegment(ctx context.Context, index int) error {
	...
	return o.Output.BeginSegment(ctx,
		...
		o.currentSegment.RedundancyStrategy,
	)
}
...
func (o *ObjectMeta) EndSegment(ctx context.Context) error {
	...
	return o.Output.CommitSegment(ctx)
}
